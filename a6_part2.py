...
def visualize_features(data):
    ...
    fig.suptitle('Houses Features vs Price', fontsize=16, fontweight='bold')
    ...
    axes[0, 0].set_xlabel('SquareFeet (SquareFeet)')
...
def make_prediction(model, sqft, bedrooms, bathrooms, age):
    ...
    car_features = pd.DataFrame([['SquareFeet', 'Bedrooms', 'Bathrooms', 'Age']], 
